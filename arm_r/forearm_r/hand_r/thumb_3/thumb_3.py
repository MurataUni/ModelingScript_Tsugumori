...
base = sw.rotate(np.pi).void(length_obj/2.)

obj2 = sw.rotate(-np.pi).parent(base).void(length_obj)
obj2.add_rib(0., [(ht_obj,0.5), (-ht_obj,0.5), (-ht_obj,-0.5), (ht_obj,-0.5)])
obj2.add_rib(0.1, [(ht_obj,1.2), (-ht_obj,1.2), (-ht_obj,-1.2), (ht_obj,-1.2)])
obj2.add_rib(1.-1.2/length_obj, [(ht_obj,1.2), (-ht_obj,1.2), (-ht_obj,-1.2), (ht_obj,-1.2)])
